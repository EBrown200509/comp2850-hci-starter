...
### Issue 1: Images must have alt text (Critical)
**Element**: `<input id="title" name="title">`<br>
**Rule**: `label` (WCAG 1.3.1, 4.1.2)<br>
**Description**: Form element does not have an associated label.<br>
**Impact**: Screen readers don't know what the input is for.<br>
**Fix**: Ensure `<label for="title">Title</label>` exists and is visible (not visually-hidden).<br>
...
### Issue 2: Elements must meet minimum color contrast ratio thresholds (Serious) 

### Issue 3: Elements must meet minimum color contrast ratio thresholds (Serious)

### Issue 4: Links must have discernible text
